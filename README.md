...
code. A stability measurement explains why â€” and the same measurement
explains what *did* work.

**Total quantum resource: 475 QPU-seconds across 26 jobs.**

ðŸ“„ **[Full write-up: PAPER.md](PAPER.md)** Â·
ðŸ”¬ **[Preregistration and all amendments](PREREGISTRATION.md)** Â·
ðŸ§¾ **[Evidence provenance: every job ID and role](runs/README.md)** Â·
ðŸ” **[Reproduce it](REPRODUCE.md)**
...
is binomially stable. Ten minutes earlier â€” the diamonds at left â€” those
...
| Measured probe, 256 shots | Spearman **Ï = âˆ’0.072** |
| Measured probe, 4096 shots, corrected aggregation | Spearman **Ï = âˆ’0.335** |
...
### What did work â€” everything measured inside one job

- **Break-even is state-dependent.** Against a duration-matched physical
  qubit, the code suppresses logical bit-value error for |1âŸ© (S = 1.5 to
  2.4) and fails to for |0âŸ© (S = 0.08 to 0.48). All twelve cells replicate
  by direction across two windows 33 hours apart.
- **The asymmetry is dose-dependent.** Across exposures of 9.6, 21.1 and
  32.6 Âµs it rises monotonically (Spearman +1.00) â€” bare |1âŸ© error grows
  133% while bare |0âŸ© stays flat, exactly as relaxation predicts.
...
- **Ratios survive drift that absolute rates do not.** Between windows,
  bare and encoded error each moved 25â€“31%; their ratio moved 11%.
...
The answer is no, in a specific and measurable way â€” and getting there
...
forbidden-analyses list â€” enforced in code, not left to discipline â€” then
...
Pilot estimation class â€” no confirmatory superiority claim is made
...
in a computational-basis memory â€” no phase-coherence claim is made or
implied.
